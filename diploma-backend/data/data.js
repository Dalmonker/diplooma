...
![Logo](https://metanit.com/web/html5/pics/4.55.png "I am as caption")
*Рис. 7.1. Скриншот*
...
![Logo](https://metanit.com/web/html5/pics/4.56.png "I am as caption")
*Рис. 7.2. Скриншот*
...
![Logo](https://metanit.com/web/html5/pics/4.78.png "I am as caption")
*Рис. 7.3. Скриншот*
`,
        },
      },
...
### Алгоритм стилизации веб-страницы
Перед стилизацией главной страницы убедитесь, что стили normalize.css и базовый сброс применены к index.html. Для этого используйте инструменты разработчика DevTools.

☝️ Важно: вся стилизация веб-страницы выполняется только с помощью классов. Используйте привязку стилей по имени тега в крайнем случае.

![Logo](https://api.selcdn.ru/v1/SEL_72086/prodLMS/files/share/3_RBqi9qo.png "I am as caption")
*Рис. 1.3 Структура проекта*


Приступим к стилизации.

Шаг 1. Оберните всё содержимое тега <body> в тег <div> с классом main-content в файле index.html.


![Logo](https://api.selcdn.ru/v1/SEL_72086/prodLMS/files/share/4_zaFYVET.png "I am as caption")
*Рис. 1.3 Структура проекта*


Шаг 2. Добавьте стилизацию для блока с классом main-content в файле style.css.
...
Эти стили выровнят контент страницы по центру, зададут ей минимальную высоту и тёмный цвет фона.

Шаг 3. Добавьте ссылке с логотипом нижний отступ — 50px. 
...
Добавьте внутренние отступы: сверху и снизу — 24px, слева и справа — 49px.

Добавьте двум ссылкам класс class=”link”.

![Logo](https://api.selcdn.ru/v1/SEL_72086/prodLMS/files/share/5_LCZkVVB.png
"I am as caption")
*Рис. 1.3 Скриншот*
...
Вот и всё, вы стилизовали главную страницу сайта!

Итог
Внимательно изучите получившийся результат и сравните с исходным макетом. Если нашли несоответствия, проверьте себя, возможно, вы пропустили какой-то шаг.

В практической работе в конце модуля вам предстоит подобным образом стилизовать вторую страницу сайта. Затем вы отправите на проверку куратору обе страницы. Куратор проверит задание и ответит на возникшие вопросы.
