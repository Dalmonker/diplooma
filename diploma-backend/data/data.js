...
![Logo](http://localhost:3000/images/picture1.1.png "I am as caption")
...
![Logo](http://localhost:3000/images/picture1.2.png "I am as caption")
...
1. Что такое свойство display? Приведите примеры его использования и объясните поведение его на странице

2. Опишите разницу между свойствами display: none и visibility: hidden. В каких случаях лучше использовать одно, а в каких другое?
          
3. Создайте страницу с использованием различных значений свойства display. Опишите, как каждый элемент страницы реагирует на заданное значение display
    ...
    blocks: [
      {
        ...
        data: {
          id: uuid.v4(),
          text: `# Лекция: Блочные и строчные стили в CSS

## Введение
Приветствую всех, кто интересуется изучением CSS! В этой лекции мы поговорим о блочных и строчных стилях в CSS и их влиянии на веб-разработку.

## Определение блочных и строчных элементов
В CSS существуют два основных типа элементов: блочные и строчные. Блочные элементы занимают всю доступную ширину на странице и начинаются с новой строки. Примерами блочных элементов являются 
## Различия в поведении блочных и строчных элементов
Блочные элементы могут содержать в себе другие блочные и строчные элементы, а также устанавливать ширину и высоту с помощью CSS свойств. Они также могут быть выровнены по горизонтали и вертикали. Строчные элементы, с другой стороны, не могут содержать блочные элементы внутри себя и игнорируют свойства ширины и высоты. Они выравниваются по базовой линии текста.

## Применение блочных и строчных стилей
Понимание различий между блочными и строчными элементами важно для создания гибкого и эффективного макета веб-страницы. Например, блочные элементы могут использоваться для создания разделов страницы, таких как заголовки, навигационные меню или контентные блоки. Строчные элементы, с другой стороны, могут быть полезны для стилизации отдельных слов или фраз внутри текста.

## Примеры использования блочных и строчных стилей
Давайте рассмотрим несколько примеров использования блочных и строчных стилей в CSS:

### Пример 1: Создание блочного элемента
\`\`\`
...
### Пример 2: Создание строчного элемента
\`\`\`
...
## Заключение
В этой лекции мы обсудили различия между блочными и строчными элементами в CSS. Помните, что правильное использование этих стилей поможет вам создавать гибкие и красивые веб-страницы. Удачи в изучении CSS!
        `,
        },
      },
      {
...
![Logo](http://localhost:3000/images/picture2.1.png "I am as caption")
...
![Logo](http://localhost:3000/images/picture2.2.png "I am as caption")
...
![Logo](http://localhost:3000/images/picture2.3.png "I am as caption")
...
![Logo](http://localhost:3000/images/picture2.4.png "I am as caption")
...
![Logo](http://localhost:3000/images/picture2.5.png "I am as caption")
...
![Logo](http://localhost:3000/images/task-test.png "I am as caption")
...
![Logo](http://localhost:3000/images/task-tesk2.png "I am as caption")
...
![Logo](http://localhost:3000/images/task-tesk3.png "I am as caption")
